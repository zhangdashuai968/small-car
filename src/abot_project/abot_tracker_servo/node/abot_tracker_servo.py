...
class AbotTrackerServo():
    def __init__(self):
        rospy.init_node('abot_tracker_servo_node', log_level=rospy.INFO)
        r = rospy.Rate(20)
    ...
    def shutdown(self):
        ...
        rospy.logwarn("now will shutdown abot tracker servo ...")

if __name__ == '__main__':
    try:
        TrackerServo = AbotTrackerServo()
        rospy.spin()
    except Exception, e:
